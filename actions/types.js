...
export const BAR_CODE_DATA = "bar code data";
export const BAR_CODE_TYPE = "bar code type";
export const ITEM_FETCH_SUCCESS = "item fetch success";
export const WALMART = "walmart";
export const SHOULD_RELOAD = " should reload";
